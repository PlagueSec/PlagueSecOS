...
grub_target_cc_version='gcc-9 (Debian 9.3.0-13) 9.3.0'
...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/9/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.04"
grub_package="grub"
grub_package_string="GRUB 2.04-8kali1"
grub_package_version="2.04-8kali1"
